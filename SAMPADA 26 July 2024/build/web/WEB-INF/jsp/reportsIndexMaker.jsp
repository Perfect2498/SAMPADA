<%-- 
    Document   : reportsIndexMaker
    Created on : 3 Feb, 2020, 2:46:36 PM
    Author     : abt
--%>
    ...
    <body style="background-color:#FBF2EA;">
        <div class="container">
            <div  class="row" id="myDIV" align="center">
                <div class="col-sm-12">
                    <div class="btn-group">
                        <a href="${pageContext.request.contextPath}/makerIndex.htm" target="content" ><button class="myButton"  style="width:100px;">Home</button></a>
                        <div class="dropdown">
