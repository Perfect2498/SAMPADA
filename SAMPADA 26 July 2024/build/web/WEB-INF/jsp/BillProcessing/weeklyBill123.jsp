<%-- 
    Document   : weeklyBill123
    Created on : Jun 19, 2024, 2:31:48 PM
    Author     : JaganMohan
--%>
        ...
        <form>
            <fieldset>
                ...
                <table>
                    ...
                    <tr><td>Revision Number</td>

<!--                                                <td><input  type="number" name="revNo" id="revNo" required/>
                        
                                                </td>-->

                        <td><select name="revNo" id="revNo1" required>
