<%-- 
    Document   : billProcessingIndexMaker
    Created on : 31 Dec, 2019, 11:04:40 AM
    ...
    <body style="background-color:#FBF2EA;">
        ...
        <div class="container">
            ...
            <div class="row" id="myDIV" align="center">
                <div class="col-sm-12">
                    <div class="btn-group">
                        <a href="${pageContext.request.contextPath}/makerIndex.htm" target="content" ><button class="billprocessbtn" style="width:130px;">Home</button></a>
                        <div class="dropdown">
