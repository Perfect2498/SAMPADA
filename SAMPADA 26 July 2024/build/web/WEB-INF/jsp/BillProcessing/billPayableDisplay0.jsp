...
////////////////////////////////////BANK STATEMENT///////////////////////
                    ...
                    if (row.find('input[type="checkbox"]').is(':checked')) {
                        ...
                        if ((le1 === parseInt(1)) && (sumBillAmt > creditAmt)) {
                            ...
                            if (updatedCreditAmt >= billAmt) {
                                ...
                                $(this).find("td:eq(7) input").val(updatedCreditAmt);

                                $(this).find("td:eq(8) input").val(pendingAmt);
    ...
    <body style="width:90%;">
        ...
        <form>
            ...
            <table id="pendingVerifyCorp" align="center" style="min-height:400px;width:36%;" class="roundedCorners">
                ...
                <thead style="background-color: #0677A1;color: white;height:30px;">
                    <tr>
                        ...
                        <th colspan="5">Interest Pending for Corporate</th>
            ...
            <table id="makerTable1" align="center" style="min-height:400px;width:81%;" class="roundedCorners">
                ...
                <tbody>
                    ...
                    <c:forEach items="${temprefundList}" var="ele">
                        ...
                        <tr>
                            ...
                            <td>${ele.billReceiveCorp.uniqueId}</td>
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <table id="makerTable" align="center" style="min-height:400px;width:81%;" class="roundedCorners">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${tempmaplist}" var="ele">
                                        ...
                                        <tr>
                                            <td>${ele.billPayableCorp.uniqueId}</td>
                                            <td>${ele.billType}</td>
                                            <td>${ele.billPayableCorp.revisionNo}</td>
                                            <td>${ele.weekId}</td>
                                            <fmt:formatDate value="${ele.billPayableCorp.billDueDate}" pattern="dd-MM-yyyy" var="billDueDate" />

                                            <td>${billDueDate}</td>

                                            <!--<td>${ele.originalAmount}</td>-->
                                            <td>${ele.billPayableCorp.pendingAmount}</td>
                        ...
                        <td>
                            ...
                            <table align="center" id="bankMapTable" style="min-height:400px;width:81%;" class="roundedCorners">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${tempbankstmtList}" var="ele">
                                        ...
                                        <tr>
                                            ...
                                            <fmt:formatDate value="${ele.bankStatement.amountDate}" pattern="dd-MM-yyyy" var="billDueDate" />
                                                            ...
                                                            <c:if test="${empty tempmapMaxlist}">
                                                                ...
                                                                <c:if test="${objectList.revisionNo==0}">
                                                                    ...
                                                                    <c:if test="${objectList.billType==priority.Priority}">
                                                                        ...
                                                                        <fmt:formatDate value="${objectList.billDueDate}" pattern="dd-MM-yyyy" var="billDueDate" />
                                                                        <td>${billDueDate}</td>
                                        ...
                                        <c:if test="${priority.Priority==refundlist.billType}">
                                            ...
                                            <c:if test="${empty temprefundList}">
                                                ...
                                                <td><input type="text" name="<%=weekid1%>"  value="${refundlist.weekId}" hidden="yes"/>${refundlist.weekId}</td>
                                                    <fmt:formatDate value="${refundlist.billDueDate}" pattern="dd-MM-yyyy" var="billDueDate" />
                                                <td>${billDueDate}</td>
                                            ...
                                            <c:forEach var="listNotINtemprefund" items="${listNotINtemprefund}">

                                                <c:if test="${listNotINtemprefund.uniqueId==refundlist.uniqueId}">

                                                    <fmt:formatDate value="${listNotINtemprefund.billingDate}" pattern="yyyy-MM-dd" var="notrecvObjdate" />



                                                    <c:if test="${billdate==notrecvObjdate}">

                                                        <c:if test="${objectWeek==listNotINtemprefund.weekId}">

                                                            <c:if test="${priority.Priority==listNotINtemprefund.billType}">
                                                                ...
                                                                <td>${listNotINtemprefund.pendingAmount}</td>
                                ...
                                <c:forEach items="${bankList}" var="ele123">
                                    ...
                                    <c:if test="${ele123.transactionBalance > 0 && ele123.bankStatement.stmtId==ele.stmtId}">
                                        ...
                                        <tr>
                                            ...
                                            <fmt:formatDate value="${ele.amountDate}" pattern="dd-MM-yyyy" var="billDueDate" />
                                            <td>${billDueDate}</td>
...
<h3 style="color:#000080; text-align: center;">Note: Please make sure Credit Dates are in ascending order before clicking Confirm button!!</h3>
<br/> <br/> <br/> <br/>
