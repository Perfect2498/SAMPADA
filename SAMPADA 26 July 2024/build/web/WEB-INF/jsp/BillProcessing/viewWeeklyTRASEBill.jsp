<%-- 
    Document   : viewWeeklyTRASEBill
    Created on : Jun 19, 2024, 5:34:12 PM
    Author     : JaganMohan
--%>
...
<html>
    ...
    <body>
        <form>
            ...
            <c:forEach items="${billTRASEdet}" var="ele">
