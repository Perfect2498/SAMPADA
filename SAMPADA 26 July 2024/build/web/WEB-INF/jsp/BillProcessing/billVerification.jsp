<%--
    Document   : billVerification
    Created on : Jun 18, 2019, 2:53:36 PM
    Author     : cdac
--%>
...
<html>
    ...
    <body style="text-align: center; alignment-adjust: central;width: 95%;">
        ...
        <form>
            ...
            <table id="pendingVerifyCorp" align="center" style="width:36%;" class="customerTable">
                <thead style="background-color: #0677A1;color: white;height:30px;">
                    <tr>
                        <th>Mapped Entries of Pool Members at Checker End</th>
                    </tr>
                </thead>
                <tbody>
                    <c:forEach items="${pendingVerifyCorpList}" var="pflow">
                        <tr>
            ...
            <table id="pendingwithoutbank" align="center" style="min-height:150px; width:36%;" class="customerTable">
                <thead style="background-color: #0677A1;color: white;height:30px;">
                    <tr>
                ...
                <tbody>
                    ...
                    <c:forEach items="${corpList}" var="penlist">

                        <c:set var="flag"  value="${0}"/>
              
                        <c:forEach items="${corpnames}" var="banlstmtlist1">

                          
                            <c:if test="${banlstmtlist1 == penlist}">
            ...
            <fieldset>
                <legend> <h3>Pool Member Available for Mapping of Bills</h3></legend>
                    ...
                    <tr><td>Select the Pool Member:</td>
                        <td><select name="corpId" id="corpId">
                                ...
                                <c:forEach items="${corpList}" var="item">
                                    <c:forEach items="${corpnames}" var="banlstmtlist">
                                        <c:if test="${banlstmtlist == item}">
