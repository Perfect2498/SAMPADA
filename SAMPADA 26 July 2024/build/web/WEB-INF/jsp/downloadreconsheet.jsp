<%--
    Document   : selectTransactionDatesBankStmt
    Created on : Sep 24, 2019, 12:14:56 PM
    Author     : cdac
--%>
...
<body style="min-height: 600px;" align="center" >
    ...
    <p style="color:red;"><c:out value="${msg}"></c:out></p><br><br>
        ...
        <fieldset id="fieldset2" style="width: 60%; " >
            ...
            <form action="Exceldownloadreconreport.htm" method="post">
                <table id="reportstable">
                    <tr><td><a  href="newReconciliationReportforallcorp.htm">Click for Refresh</a></td></tr>
