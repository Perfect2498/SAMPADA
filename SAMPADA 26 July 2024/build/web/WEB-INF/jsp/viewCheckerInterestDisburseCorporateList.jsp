<%--
    ...
    Document   : viewCheckerInterestDisburseCorporateList

    Created on : Nov 21, 2019, 3:44:02 PM
...
<html>
    ...
    <body style="min-height: 500px;">
        ...
        <form>
            ...
            <h4 align="center">List of Pool Member for Interest Checker</h4>
            ...
            <table align="center" width="200" border="yes">
                ...
                <c:forEach items="${disInterestDisList}" var="ele">
                    ...
                    <tr>
                        ...
                        <td><a href="<c:url value='viewCheckerInterestReceivableDetails.htm'>
