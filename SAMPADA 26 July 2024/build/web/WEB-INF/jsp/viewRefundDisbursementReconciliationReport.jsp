<%--
   Document   : viewRefundDisbursementReconciliationReport
   Created on : Dec 26, 2019, 10:56:59 AM
   Author     : JaganMohan
...
<html>
   <head>
       ...
       <body width="80%">
           <form name="disbursecheckerForm" method="post" action="submitRefundDisbursementReconciliationReport.htm">
               <p>&nbsp;</p>
               <h3 align="center" style="color:#003366;" >Bank Disbursement Details </h3>
               <table align="center" style="width:80%;" cellspacing="0" id="billtable" class="customerTable">
                   ...
                   <tbody>
                       ...
                       <c:forEach items="${bankList}" var="ele">
                           ...
                           %>
                           <c:forEach items="${refundList}" var="ele1">


                               <c:if test="${ele1.slno==ele.disburseId}">
                                   <tr>
                                       <td><input type="text" name="<%=disburseid1%>" value="${ele.disburseId}" hidden="yes"/>${ele.disburseId}</td>
                                       <td>${ele1.weekid}</td>
