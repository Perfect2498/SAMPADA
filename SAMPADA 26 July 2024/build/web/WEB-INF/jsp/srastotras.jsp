<%-- 
    Document   : srastotras
    Created on : 14 Sep, 2023, 3:37:17 PM
    Author     : root
--%>
...
<html>
    <head>
        ...
        <script>
            ...
            function validatecsdf()
            {
                ...
                var intbal = document.getElementById("intbal").value;
                ...
                if (csdfamt != "0")
                {
                    ...
                    {
                        if (-(+csdfamt) > +intbal){
                            alert('Please check that Disburse value is greater than TRAS Balance');
                            return false;
                        }
                    }
                    else
                    {
                        if (+csdfamt > +mainbal){
                            alert('Please check that Disburse value is greater than SRAS Balance');
                            return false;
                        }
                    }
                }
                ...
                {
                    alert('Please provide the Transfer Amount');
                    return false;
                }
    ...
    <body  width="95%">
        <form name="billDirbusementInfoForm" method="post">
            <h3 align="center" style="color:#003366;" > ${billtype} Pool Account Details</h3>
                ...
                <tbody>
                    <c:forEach items="${pooldetails}" var="ele">
                        <tr>
                            ...
                            <td>${intbal}</td>
                    <input type="text" name="intbal" id="intbal" value="${intbal}"  hidden/>
           ...
           <h3 align="center" style="color:red;" >+ve amount : From SRAS Amount to TRAS Amount</h3>
           <h3 align="center" style="color:red;" >-ve amount : From TRAS Amount to SRAS Amount</h3>
           ...
           <table align="center" style="width:80%;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="doc_sets" id="doc_sets" required>
