<%--
   Document   : viewCheckerDisbursement
   Created on : Jul 2, 2019, 12:45:35 PM
   Author     : JaganMohan
...
<html>
    ...
    <body width="80%">
        <form name="checkerForm">
            ...
            <p align="center">Main Pool Account Balance (Before disbursement) ${mainpool}</p>
            <h3 align="center" style="color:#003366;" >Disbursement Details </h3>
            ...
            <table align="center" id="refundTable" style="width:80%;" class="customerTable">
                ...
                <tbody>
                    ...
                    <c:forEach items="${listrefundDisbusrse}" var="ele1">
                        <%
                            cnt++;
                        %>
                        <tr>
