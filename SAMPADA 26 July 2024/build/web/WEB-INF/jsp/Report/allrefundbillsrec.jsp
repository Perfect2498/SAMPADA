<%--
    Document   : allrefundbillsrec
    Created on : Nov 22, 2019, 5:13:22 PM
    Author     : Administrator
--%>


<%@page import="sampada.pojo.MappingRefundBank"%>
<%@page import="sampada.DAO.MappingRefundBankDAO"%>
...
<html>
    ...
    <body onload="setIframeHeight(this.id);" align="center" style="width:95%;" >
        ...
        <form>
            <fieldset>
                <legend> <h3>Refund Payable Report</h3></legend>
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${queryList1}" var="list">
                            ...
                            <tr>
                                ...
                                <c:if test="${list.pendingAmount==0}">
                                    <%
                                        BillReceiveCorp obj = (BillReceiveCorp) pageContext.getAttribute("list");
                                        MappingRefundBankDAO mrbkdao = new MappingRefundBankDAO();
                                        MappingRefundBank mrbk = mrbkdao.getMappingRefundBankbyUid(obj.getUniqueId());
                                        String paiddate = mrbk.getBankStatement().getAmountDate().toString();
                                    %>
