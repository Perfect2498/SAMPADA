<%--
    Document   : monthlyRecvBillTypeWiseReport
    Created on : Nov 15, 2019, 3:44:23 PM
    Author     : cdac
--%>
                ...
                <table id="payableTable" align="center" style="min-height:400px;width:81%;" class="roundedCorners">
                    <thead style="background-color: #0677A1;color: white;height:30px;">
                        <tr>
                            ...
                            <th>Net Disburse Amount</th>
                            <th>Disbursed Amount</th>
                            <th>Pending Disburse Amount</th>
                            <th>Refund Disburse Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:forEach items="${queryList1}" var="list">
                            <tr>
                                ...
                                <td>${list.weekId}</td>
                                <td>${list.billingDate}</td>
                                <td>${list.revisionNo}</td>
                                <td>${list.disburseStatus}</td>
                                <td>${list.toalnet}</td>
                                <td>${list.disburseAmount}</td>
