...
<html>
    ...
    <body onload="setIframeHeight(this.id);" align="center" style="width:95%;" > 
       ...
       <form>
        <fieldset>
            <legend> <h3>Entity  ${payrrec} FINAL  ${type}-Report</h3></legend>
                ...
                <tr>
                     <th>ENTITTY_NAME</th>
                      <th>BILL YEAR</th>
                        <th>WEEK ID</th>
                        <th>Rev_NO </th>
                        <th>TOTAL AGC UPDOWN MWH</th>
                        <th>MARKUP CHARGES </th>
                        <th>TOTALNET AGC</th>
                         <th>AGC ENERGY CHARGES</th>
                       <th>TOTAL CHARGES</th>
                        ...
                        <tr>
                         ...
                         <td>${list.entites.entittyName}</td> 
                          <td>${list.billYear}</td> 
                           ...
                           <td>${list.totalAgcUpdownMwh}</td> 
                            <td>${list.markupCharges}</td> 
                            <td>${list.totalnetAgc}</td> 
                             <td>${list.agcEnergycharges}</td> 
                              <td>${list.totalcharges}</td> 
                         </tr>
                    </c:forEach>      
            <p>&nbsp;</p>  
            <p>&nbsp;</p>
