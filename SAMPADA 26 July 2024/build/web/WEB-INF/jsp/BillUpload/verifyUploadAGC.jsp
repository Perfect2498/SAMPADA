<%--
    Document   : verifyUploadAGC
    Created on : Nov 1, 2019, 5:43:37 PM
    Author     : cdac
--%>
                    ...
                    "buttons": [
                        {
                            extend: 'pdf',
                            footer: true,
                            title: 'AGC Bill billNo.' + billNo + ' Week No. ' + weekId + 'Issue Date:' + billingDate,
                            orientation: 'landscape',
                            messageTop: function () {
                                return '\r\n         Week No. ' + weekId + '      Bill Issue Date:' + billingDate +
                                        '\r\n \r\n DETAILS OF AGC CHARGES FOR THE WEEK FROM ' + fromDate + '  TO ' + toDate +
                                        '\r\n \r\n (All figures in Rs.)';
                            }
                        },
                        {
...
//                                );
    ...
    <body style="min-height: 1500px; width: 95%">
        <form method="post">
            ...
            <h4 style="color: #d43f3a;">AGC Bill No :&emsp;${tempagcdetils.get(0).billNo}</h4>
            ...
            <table style="color:#003366; width: 90%;" align="center"  border="yes">
                <tr><td align="center"><b> Details of AGC Charges for week From <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempagcdetils.get(0).weekFromdate}" /> To <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempagcdetils.get(0).weekTodate}" /></b> </td></tr>
            ...
            <table id="InterestreportDatatable" style="color:#003366; width: 90%;" align="center"  border="yes">
                <thead style="min-height: 15px;height: 30px;">
                    <tr>
                        ...
                        <th>Total AGC UP and Down regulation(MWh) (based on 5-Min schedule) (A)</th>
