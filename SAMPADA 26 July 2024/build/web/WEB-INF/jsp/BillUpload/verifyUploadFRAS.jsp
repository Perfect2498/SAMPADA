<%--
    Document   : verifyUploadFRAS
    Created on : Nov 2, 2019, 12:33:20 PM
    Author     : cdac
--%>
...
<html>
    <head>
        ...
        <title>Verify Upload FRAS Page</title>
                    ...
                    "buttons": [
                       {
                            extend: 'pdf',
                            footer: true,                          
                             title: 'FRAS Bill  billNo.'+billNo+' Week No. ' + weekId +  'Issue Date:' + billingDate,
    ...
    <body style="min-height: 1500px; width: 95%">
        <form method="post">
           ...
           <h4 style="color: #d43f3a;">FRAS Bill No :&emsp;${tempbilfrasdetls.get(0).billNo}</h4>
           
            <h4 style="color: #d43f3a;">Bill Issued Date:&emsp;<fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempbilfrasdetls.get(0).billingDate}" /></h4>
            <h4 style="color: #d43f3a;">Revision No. &emsp;${tempbilfrasdetls.get(0).revisionNo}</h4>
            <h4 style="color: #d43f3a;">Week No. &emsp;${tempbilfrasdetls.get(0).weekId}</h4>
            <h4 style="color: #d43f3a;">Bill Due Date &emsp;<fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempbilfrasdetls.get(0).billDueDate}" /></h4>

            <table style="color:#003366; width: 90%;" align="center"  border="yes">
                <tr><td align="center"><b> Details of FRAS Charges for week From <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempbilfrasdetls.get(0).weekFromdate}" /> To <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempbilfrasdetls.get(0).weekTodate}" /></b> </td></tr>
            ...
            <table id="InterestreportDatatable" style="color:#003366; width: 90%;" align="center"  border="yes">
                <thead style="min-height: 15px;height: 30px;">
                    <tr>
                        ...
                        <th>Calculated Markup Charges as per CERC order (Rs) [C =(A+B)*100]</th>
                        <th>WRLDC Markup Charges as per CERC order (Rs) [C =(A+B)*100]</th>
                        <th>WRLDC Remarks</th>
                    </tr>
                </thead>
