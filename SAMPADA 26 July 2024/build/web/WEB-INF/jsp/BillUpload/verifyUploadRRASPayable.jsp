<%--
    Document   : verifyUploadRRASPayable
    Created on : Jun 28, 2019, 2:17:19 PM
    Author     : shubham
--%>
...
<html>
    ...
    <body style="min-height: 1500px;">
        <form method="post">
            ...
            <h4 style="color: #d43f3a;">RRAS Payable Bill No :&emsp;${tempbilrrasdetilspay.get(0).billNo}</h4>
           
            <h4 style="color: #d43f3a;">Bill Issued Date:&emsp;<fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempbilrrasdetilspay.get(0).billingDate}" /></h4>
            <h4 style="color: #d43f3a;">Revision No. &emsp;${tempbilrrasdetilspay.get(0).revisionNo}</h4>
            <h4 style="color: #d43f3a;">Week No. &emsp;${tempbilrrasdetilspay.get(0).weekId}</h4>
            <h4 style="color: #d43f3a;">Bill Due Date &emsp;<fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempbilrrasdetilspay.get(0).billDueDate}" /></h4>
            <table style="color:#003366; width: 90%;" align="center"  border="yes">
                <tr><td align="center"><b> Details of RRAS Payable Charges for week From <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempbilrrasdetilspay.get(0).weekFromdate}" /> To <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempbilrrasdetilspay.get(0).weekTodate}" /></b> </td></tr>
            ...
            <table id="InterestreportDatatable" style="color:#003366; width: 90%;" align="center"  border="yes">
                <thead style="min-height: 15px;height: 30px;">
                    <tr>
                        ...
                        <th>Energy Scheduled from VAE under RRAS (MWh)</th>
                        <th>Total Variable Charges for generation reduced (Rs) (A)</th>
                        <th> Calculated Variable Charges to be paid to DSM pool (Rs) (B= 75% of A) </th>

                        <th>WRLDC Variable Charges to be paid to DSM pool (Rs) (B= 75% of A) </th>
                        <th>WRLDC Remarks</th>
