<%-- 
    Document   : excelTRASMUpload
    Created on : 23 Aug, 2023, 3:18:11 PM
    Author     : root
--%>
    ...
    <body>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br/>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <legend style="font-size: 16px; color:#003366;"><b>Upload TRAS-M Sheet</b></legend>
                ...
                <table align="center" style="width: 100%;">
                    <a  href="downloadTRASMTemplate.htm">Download TRAS-M Template</a>
                    <div class="noborderedtable" style="color: #003366;" align="center"><br>

                    <form:form action="uploadTRASM.htm" id="form1" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
                        <div id="weekNo"></div>
                        <br/>
                        <div class="container">
