<%-- 
    Document   : excelSRASUpload
    Created on : 14 Aug, 2023, 5:35:15 PM
    Author     : root
--%>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br/>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <table align="center" style="width: 100%;">
                    <a  href="downloadSRASTemplate.htm">Download SRAS Template</a>
                    <div class="noborderedtable" style="color: #003366;" align="center"><br>

                    <form:form action="uploadSRAS.htm" id="form1" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
                        <div id="weekNo"></div>
                        <br/>
                        <div class="container">
