<%--
    Document   : excelDSMUpload
    Created on : Jun 25, 2019, 10:38:03 AM
    Author     : shubham
--%>
    ...
    <body>
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br/>
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <a  href="downloadDSMTemplate.htm">Download DSM Template</a>
                <div class="noborderedtable" style="color: #003366;" align="center"><br>
                <form:form action="uploadDSM.htm" id="form1" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
                    <div id="weekNo"></div>
                    <br/>
                    <div class="container">
                        <div class="row">
