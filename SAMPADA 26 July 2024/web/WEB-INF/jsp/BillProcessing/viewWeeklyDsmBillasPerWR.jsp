    ...
    <body>
        <form>
            ...
            <table align="center" class="customerTable" id="payableTable" style="width:90%;">
                ...
                <tbody>
                    <tr><td colspan="9" style="background-color: linen;text-align: center;">INTER REGIONAL</td></tr>
                    ...
                    <tr><td colspan="9" style="background-color: linen;text-align: center;">BENEFICIERIES/BUYERS OF WR</td></tr>
                    <c:set var="serialno" value="${0}"/>
                    <c:forEach items="${billPay}" var="ele">
                    ...
                    <tr><td colspan="9" style="background-color: linen;text-align: center;">GENERATING STATIONS(TARIFF DETERMINED BY CERC)</td></tr>
                    <c:set var="serialno" value="${0}"/>
                    <c:forEach items="${billPay}" var="ele">
                    ...
                    <tr><td colspan="9" style="background-color: linen;text-align: center;">OTHER GENERATING STATIONS</td></tr>
                    <c:set var="serialno" value="${0}"/>
                    <c:forEach items="${billPay}" var="ele">
                    ...
                    <tr><td colspan="9" style="background-color: linen;text-align: center;">WIND AND SOLAR GENERATORS</td></tr>
                    <c:set var="serialno" value="${0}"/>
                    <c:forEach items="${billPay}" var="ele">
                    ...
                    <tr><td colspan="9" style="background-color: linen;text-align: center;">INFIRM GENERATORS</td></tr>
                    <c:set var="serialno" value="${0}"/>
