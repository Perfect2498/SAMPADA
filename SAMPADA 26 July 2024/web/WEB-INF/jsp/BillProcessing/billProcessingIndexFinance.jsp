<%-- 
    Document   : billProcessingIndexFinance
    Created on : 3 Feb, 2020, 1:06:26 PM
    Author     : abt
--%>
   ...
   <body style="background-color:#FBF2EA;">
       ...
       <div class="container">
           ...
           <div class="row" id="myDIV" align="center">
               <div class="col-sm-12">
                   <div class="btn-group">
                       <a href="${pageContext.request.contextPath}/financeindex.htm" target="content" ><button class="billprocessbtn" style="width:130px;">Home</button></a>
<!--                       <div class="dropdown">
                           <button class="billprocessbtn active" style="width:150px;">Bill Upload</button>
                           <div class="dropdown-content" style="width:200px;">
                               ...
                               <a href="${pageContext.request.contextPath}/import/importRRASPayableTemplate.htm" target="appcontent" >RRAS Down Regulation  </a>
                               <a href="${pageContext.request.contextPath}/import/importRRASReceivableTemplate.htm" target="appcontent" >RRAS Up Regulation  </a>
...
<!--                       <div class="dropdown">
                           <button class="billprocessbtn" style="width:100px;">Bills</button>
...
<!--                       <div class="dropdown">
                           <button class="billprocessbtn" style="width:100px;">Checker</button>
                           <div class="dropdown-content">
                       ...
                       <div class="dropdown">
                           <button class="billprocessbtn" style="width:100px;">Pending</button>
                           <div class="dropdown-content">
                       ...
                       <div class="dropdown">
                           <button class="billprocessbtn" style="width:100px;">View Bills</button>
                           <div class="dropdown-content">
                               <a href="weeklyBill.htm" target="appcontent">Weekly</a>                              
                               <!--<a href="underConstruction.htm" target="appcontent" >Closed</a>-->
                           </div>
                       </div>
                       <a href="${pageContext.request.contextPath}/logout.htm" target="content"><button class="billprocessbtn" style="width:90px;">Logout</button></a>
                   </div>
               </div>
           </div>
            <p align="left" style="margin-left: 15%;"><span style='font-size:20px;'>&#128073;&nbsp;</span>Home->Bill Processing</p>
           <div class="row">
               <div class="col-sm-12">
