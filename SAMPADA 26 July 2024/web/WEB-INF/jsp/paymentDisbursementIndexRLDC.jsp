<%--
    Document   : paymentDisbursementIndexRLDC
    Created on : Jun 18, 2019, 8:42:33 AM
    Author     : JaganMohan
--%>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="newDisbursement.htm" target="appcontent" >DSM/AGC/RRAS </a>
                                <a href="newDisbursementsras.htm" target="appcontent" >SRAS Disburse</a>
                                <a href="newDisbursementtras.htm" target="appcontent" >TRAS Disburse</a>
                        ...
                        <div class="dropdown">
                            <button class="myButton" style="width:150px;">Interest</button>
                            <div class="dropdown-content">
                                <!--<a href="newDisbursement.htm" target="appcontent" >New Disburse</a>-->
                                <a href="viewBillInterestReceivableDetails.htm" target="appcontent" >DSM/AGC/RRAS</a>
                                <a href="viewBillInterestReceivableDetailssras.htm" target="appcontent" >New SRAS</a>
                                <a href="viewBillInterestReceivableDetailstras.htm" target="appcontent" >New TRAS</a>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <!--                               <a href="viewPendingRefundReceivableList.htm" target="appcontent" >Pending Refund</a>-->
                        ...
                        <div class="dropdown">
                            ...
                            <button class="myButton" style="width:150px;">Checker</button>
