<%-- 
    Document   : dsmtosras
    Created on : 14 Sep, 2023, 11:25:15 AM
    Author     : root
--%>
...
<html>
        ...
        <script>
            ...
            function validatecsdf()
            {
                ...
                if (csdfamt != "0")
                {
                    ...
                    {
                        if (+csdfamt > +mainbal){
                            alert('Please check that Disburse value is greater than DSM Balance');
                            return false;
                        }
                    }
                }
    ...
    <body  width="95%">
        <form name="billDirbusementInfoForm" method="post">
           ...
           <h3 align="center" style="color:red;" >+ve amount : From DSM Amount to SRAS Amount</h3>
           <h3 align="center" style="color:red;" >-ve amount : From SRAS Amount to DSM Amount</h3>
