<%-- 
    Document   : dsmtotras
    Created on : 14 Sep, 2023, 3:25:49 PM
    Author     : root
--%>
...
<html>
    ...
    <body  width="95%">
        <form name="billDirbusementInfoForm" method="post">
           ...
           <h3 align="center" style="color:red;" >+ve amount : From DSM Amount to TRAS Amount</h3>
           <h3 align="center" style="color:red;" >-ve amount : From TRAS Amount to DSM Amount</h3>
