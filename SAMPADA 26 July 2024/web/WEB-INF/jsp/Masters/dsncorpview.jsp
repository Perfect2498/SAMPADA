<%-- 
    Document   : dsncorpview
    Created on : 18 Mar, 2020, 1:52:44 PM
    Author     : abt
--%>
    ...
    <body style="background-color:#FBF2EA;" width="95%">
        ...
        <form>
            <table align="center" id="example" class="customerTable" style="width:81%; ">
                ...
                <tbody>
                    <c:forEach items="${bankstmtlist}" var="list">
                        <tr>
                            ...
                            <td><a name="stmtId" href="<c:url value='viewdsn.htm'> <c:param name="stmtId" value="${list.stmtId}"/> </c:url>" class="btn"><span style='font-size:20px;'>&#9999;</span>Upload</a></td>
