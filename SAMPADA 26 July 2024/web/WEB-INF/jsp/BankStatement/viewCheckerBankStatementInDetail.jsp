<%--
    Document   : viewCheckerBankStatementInDetail
    Created on : Dec 5, 2019, 4:38:30 PM
    Author     : cdac
--%>
...
<html>
    ...
    <body style="text-align: center; alignment-adjust: central;width: 95%;min-height: 1500px;">
        ...
        <form method="post">
            ...
            <input type="text" name="fromDate" value="${frmDate}" hidden/>
            ...
            <p align="center">
                <input style="width:100px;" class="btn" onclick="return validate();" type="submit" name="bconfirm"  value="Verify"/>
