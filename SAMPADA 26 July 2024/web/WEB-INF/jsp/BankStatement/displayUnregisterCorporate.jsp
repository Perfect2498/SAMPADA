<%--
    Document   : displayUnregisterCorporate
    Created on : Jul 19, 2019, 12:23:02 PM
    Author     : cdac
--%>
...
<html>
    ...
    <body>
        ...
        <h3 style="color: #003366;text-align:center;"><i><b>Unregistered Bank Sub Account Number</b></i></h3>
        <form>
            <table id="InterestreportDatatable" style="text-align:center;color:#003366; width: 63%;" align="center"  border="yes">
                <thead style="min-height: 15px;height: 30px;">
                    <tr><th>S. No.</th><th>Bank Sub Account Number</th></tr>
                </thead>
                <tbody>
            ...
            <p style="color:maroon;font-style: italic ;text-align:center;">Bank Statement Upload fail due to Bank Sub Account Number/s!!<br/> Kindly register or modify Bank Sub Account Number/s in the current  bank statement which you were trying to upload!!</p>
            <br/>
