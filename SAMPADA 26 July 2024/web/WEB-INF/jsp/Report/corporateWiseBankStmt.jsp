<%--
    Document   : corporateWiseBankStmt
    Created on : Nov 15, 2019, 4:56:08 PM
    Author     : cdac
--%>
...
<body style="min-height: 600px;" align="center" >
    ...
    <p style="color:red;"><c:out value="${msg}"></c:out></p><br><br>
        ...
        <fieldset id="fieldset2" style="width: 60%; " >
            ...
            <legend style="font-size: 16px;"><b>${title}</b></legend>
            <form>
                <table id="reportstable">
                    ...
                    <tr> <td> Transaction End Date</td>
                        <td><input type="text" name="enddate" id="datepicker1" required autocomplete="off" onchange="return cmpDates();"/></td>
                    </tr>
