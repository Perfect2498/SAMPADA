...
<html>
    ...
    <body onload="setIframeHeight(this.id);" align="center" style="width:95%;" >
        ...
        <form>
            <fieldset>
                <legend> <h3>Pool Member All Bills  Report</h3></legend>
                ...
                <table id="payableTable" align="center" style="min-height:400px;width:81%;" class="customerTable">
                    <thead style="background-color: #0677A1;color: white;height:30px;">
                        <tr>
                            ...
                            <th>Bill Year</th>
                            <th>Bill type</th>
                            <th>WEEK_ID payable</th>
                            <th>Rev_NO payable</th>
                            <!--<th>Total Net payable</th>-->
                            <th>Bill Status payable</th>
                            <th>Bill Year</th>
                            <th>Bill type</th>
                            <th>WEEK_ID receivable</th>
                            <th>Rev_NO receivable</th>
                            <!--<th>Total Net receivable</th>-->
                            <th>Disburse Status receivable </th>
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${queryList2}" var="list1">
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td>${list1.billYear}</td>
                                <td>${list1.billType}</td>
                                <td>${list1.weekId}</td>
                                <td>${list1.revisionNo}</td>
                                <td>${list1.disburseStatus}</td>
                            </tr>
