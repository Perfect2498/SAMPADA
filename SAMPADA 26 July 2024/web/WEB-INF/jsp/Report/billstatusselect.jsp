<%-- 
    Document   : billstatusselect
    Created on : Nov 21, 2019, 2:42:14 PM
    ...
    <script type="text/javascript">
         $(document).ready(function()
        {
            $(".monthPicker").datepicker({
                ...
                yearRange: '2019:+10',
                monthNamesShort: [ "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", "Jan", "Feb", "Mar" ],
                        ...
                        <tr><td>Select Quarter:</td>
                           <td> 
                            ...
                            <select name="quar" id="quar" >
                                <option value="SELECT">SELECT</option>
                                <option value="quar1">first quarter [1 April – 30 June]</option>
                                <option value="quar2">second quarter [1 July – 30 September]</option>
                                <option value="quar3">third quarter [1 October – 31 December]</option>
                                <option value="quar4">fourth quarter [1 January – 31 March]</option>
                              </select>
