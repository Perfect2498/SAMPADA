<%-- 
    Document   : MasterMakerIndex
    Created on : 3 Feb, 2020, 2:07:33 PM
    Author     : abt
--%>
        ...
        <div class="container">
           ...
           %>
            ...
            <div  class="row" id="myDIV" align="center">
                <div class="col-sm-12">
                    <div class="btn-group">
                        <a href="${pageContext.request.contextPath}/makerIndex.htm" target="content" ><button class="btn"  style="width:130px;"><span style='font-size:15px;'>&#127968;</span>Home</button></a>
                        <div class="dropdown">
                        ...
                        <div class="dropdown">
                            <button class="btn" style="width:120px;">Misc</button>
                            <div class="dropdown-content">
