<%--
    ...
    Document   : viewPendingInterestPayableList

    Created on : Dec 11, 2019, 10:54:49 AM
...
<html>
    ...
    <body style="text-align: center; alignment-adjust: central;width: 95%;">
        ...
        <form name="pendinterestverify" >
            ...
            <h3 align="center" style="color:#003366;">View Payable Interest Pending by Corporates</h3>
            ...
            <table align="center" id="interestChecker" style="width:90%;" class="customerTable">
                ...
                <tbody>
                    ...
                    <c:forEach items="${interestPendList}" var="ele">
                        ...
                        <tr>
                            ...
                            <fmt:formatDate value="${ele.billingDuedate}" pattern="dd-MM-yyyy" var="dueDate" />
                            <td>${dueDate}</td>
