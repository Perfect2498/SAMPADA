<%--
    Document   : reportsIndexRLDC
    Created on : Jun 18, 2019, 8:43:07 AM
    Author     : JaganMohan
--%>
    ...
    <body style="background-color:#FBF2EA;">
        <div class="container">
            <div  class="row" id="myDIV" align="center">
                <div class="col-sm-12">
                    <div class="btn-group">
                        <a href="${pageContext.request.contextPath}/sysadminIndex.htm" target="content" ><button class="myButton"  style="width:100px;">Home</button></a>
                        <div class="dropdown">
