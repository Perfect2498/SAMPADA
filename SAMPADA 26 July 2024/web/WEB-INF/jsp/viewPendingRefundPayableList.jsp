<%--
    ...
    Document   : viewPendingRefundPayableList

    Created on : Dec 11, 2019, 11:39:04 AM
...
<html>
    ...
    <body width="80%">
        ...
        <form name="checkerForm">
            ...
            <h3 align="center" style="color:#003366;" >Refund Payable Details </h3>
            ...
            <table align="center" id="interestChecker" style="width:90%;" class="customerTable">
                ...
                <tbody>
                    ...
                    <c:forEach items="${pendrefundpayList}" var="ele">
                        ...
                        <tr>
                            ...
                            <td>${ele.revisedrefund-ele.adjustmentAmount}</td>
                            <c:set var="duedate" value="${ele.billDueDate}"/>
                            <c:set var="pendamt" value="${ele.revisedrefund-ele.adjustmentAmount}"/>
                            <%
