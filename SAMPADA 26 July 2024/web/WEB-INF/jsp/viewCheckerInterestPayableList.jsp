<%--
    ...
    Document   : viewCheckerInterestPayableList

    Created on : Nov 22, 2019, 9:58:52 AM
...
<html>
    ...
    <body style="min-height: 500px;">
        ...
        <form name="intesdisburselist" method="post">
            ...
            <h4 align="center">View Verification of Interest Mapping done by Maker, pending at Checker End</h4>
            ...
            <table align="center" width="200" border="yes">
                ...
                <c:forEach items="${interestCheckerList}" var="ele">

                    <tr>

                        <td><a href="<c:url value='viewCheckerInterestPayableDetails.htm'>
