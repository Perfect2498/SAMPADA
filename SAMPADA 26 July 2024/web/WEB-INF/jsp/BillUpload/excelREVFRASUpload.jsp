<%-- 
    Document   : excelREVFRASUpload
    Created on : May 11, 2020, 10:24:00 AM
    Author     : cdac
--%>
    ...
    <body>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br/>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <legend style="font-size: 16px; color:#003366;"><b>Upload FRAS Sheet</b></legend>
            ...
            <table align="center" style="width: 100%;">
                <a  href="downloadREVFRASTemplate.htm">Download REVISION FRAS Template</a>
                <div class="noborderedtable" style="color: #003366;" align="center"><br>

                <form:form action="uploadREVFRAS.htm" id="form1" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
                    <div id="weekNo"></div>
                    <br/>
                    <div class="container">
...
//                    if ((ext == "xlsx") && (name == "fras_excel_file")) {
//                        formOK = true;
                //                    }
                if ((ext == "xlsx")) {
                    formOK = true;
                    ...
                    formOK = false;
                    alert("Please upload fras_excel_file");
                    $("#uploadexcelfile").val('');
                }
                return formOK;
            });
