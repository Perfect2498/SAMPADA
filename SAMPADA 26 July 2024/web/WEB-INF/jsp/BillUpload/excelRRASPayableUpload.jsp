<%--
    Document   : excelRRASPayableUpload
    Created on : Jun 28, 2019, 9:42:28 AM
    Author     : kritika
--%>
    ...
    <body>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br><br>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <table>
                    <a  href="downloadRRASPayableTemplate.htm">Download RRAS Down Regulation Bill Template</a>
                    <div class="noborderedtable" style="color: #003366;" align="center"><br>

                    <form:form action="uploadRRASPayable.htm" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
