<%-- 
    Document   : excelREVAGCUpload
    Created on : 20 Apr, 2020, 1:14:07 AM
    Author     : abt
--%>
    ...
    <body>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br/>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <legend style="font-size: 16px; color:#003366;"><b>Upload AGC Sheet</b></legend>
            ...
            <table align="center" style="width: 100%;">
                <a  href="downloadREVAGCTemplate.htm">Download REVISED AGC Template</a>
                <div class="noborderedtable" style="color: #003366;" align="center"><br>

                <form:form action="uploadREVAGC.htm" id="form1" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
                    <div id="weekNo"></div>
                    <br/>
                    <div class="container">
