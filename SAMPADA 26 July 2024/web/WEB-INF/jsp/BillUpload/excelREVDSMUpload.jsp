<%-- 
    Document   : excelREVDSMUpload
    Created on : 5 Apr, 2020, 3:24:10 PM
    Author     : abt
--%>
    ...
    <body>
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br/>
            <fieldset  style="width:90%;margin-left: 10%;">
                <legend style="font-size: 16px; color:#003366;"><b>Upload DSM Sheet</b></legend>
            ...
            <a  href="downloadREVDSMTemplate.htm">Download REVISION DSM Template</a>
            <div class="noborderedtable" style="color: #003366;" align="center"><br>
            <form:form action="uploadREVDSM.htm" id="form1" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
                <div id="weekNo"></div>
                <br/>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 form-group">
                            <div class="input-group" id="DateDemo">
                                ...
                                <!--<button id="getweek" style="width:60px;height:30px;background-color: antiquewhite;">Get</button>-->
                            </div>
                        </div>
                    </div>
                    <br/>
...
//                    if ((ext == "xlsx") && (name == "dsm_excel_file")) {
//                        formOK = true;
                //                    }
                if ((ext == "xlsx")) {
                    formOK = true;
                    ...
                    formOK = false;
                    alert("Please upload DSM_excel_file");
                    $("#uploadexcelfile").val('');
                }
                return formOK;
            });
