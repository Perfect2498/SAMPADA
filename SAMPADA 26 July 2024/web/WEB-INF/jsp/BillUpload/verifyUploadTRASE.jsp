<%-- 
    Document   : verifyUploadTRASE
    Created on : 31 Aug, 2023, 5:44:10 PM
    Author     : root
--%>
                    ...
                    "buttons": [
                        {
                            extend: 'pdf',
                            footer: true,
                            title: 'TRAS-E Bill billNo.' + billNo + ' Week No. ' + weekId + 'Issue Date:' + billingDate,
                            orientation: 'landscape',
                            messageTop: function () {
                                return '\r\n         Week No. ' + weekId + '      Bill Issue Date:' + billingDate +
                                        '\r\n \r\n DETAILS OF TRAS-E CHARGES FOR THE WEEK FROM ' + fromDate + '  TO ' + toDate +
                                        '\r\n \r\n (All figures in Rs.)';
                            }
                        },
                        {
...
//                                );
    ...
    <body style="min-height: 1500px; width: 95%">
        <form method="post">
            ...
            <h4 style="color: #d43f3a;">TRAS-S Bill No :&emsp;${tempagcdetils.get(0).billNo}</h4>
            ...
            <table style="color:#003366; width: 90%;" align="center"  border="yes">
                <tr><td align="center"><b> Details of TRAS-E Charges for week From <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempagcdetils.get(0).weekFromdate}" /> To <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempagcdetils.get(0).weekTodate}" /></b> </td></tr>
            ...
            <table id="InterestreportDatatable" style="color:#003366; width: 90%;" align="center"  border="yes">
                <thead style="min-height: 15px;height: 30px;">
                    <tr>
                        ...
                        <th>S.No </th>
                        <th>TRAS Provider Name</th>



                        <th>Energy scheduled under Emergency TRAS-Up (MWh) (A)</th>
                        <th>Total charges/ Compensation charges for Emergency TRAS-Up (Rs) (B)</th>
                        <th>Energy scheduled under Emergency TRAS- Down (MWh) (C)</th>
                        <th>Total charges/Compensation charges for Emergency TRAS-Down to be paid back to Pool(Rs) (D)</th>
