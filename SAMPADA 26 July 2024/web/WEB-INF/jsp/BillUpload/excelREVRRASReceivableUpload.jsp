<%-- 
    Document   : excelREVRRASReceivableUpload
    Created on : 16 Apr, 2020, 6:32:15 AM
    Author     : abt
--%>
    ...
    <body>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br><br>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <legend style="font-size: 16px;"><b>Upload Revised RRAS Up Regulation Bill</b></legend>
            ...
            <table>
                <a  href="downloadREVRRASReceivableTemplate.htm">Download Revised RRAS Up Regulation Bill Template</a>
                <div class="noborderedtable" style="color: #003366;" align="center"><br>

                <form:form action="uploadREVRRASReceivable.htm" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                                ...
                                <div class="input-group" id="DateDemo">
                                    ...
                                    <!--<button class="btn" id="getweek" style="width:60px;height:30px;background-color: antiquewhite;">Get</button>-->
                    ...
                    <div style="text-align:center">
                        ...
                        <input type="submit" value="&#128228;Upload" class="btn"  name="upload" id="uploadbutton" align="center" style="font-size:14px;  ">
                    </div>
...
//                    if ((ext == "xlsx") && (name == "rras_up_regulation_bill_excel")) {
//                        formOK = true;
//                    }
                if ((ext == "xlsx")) {
                    formOK = true;
                    ...
                    formOK = false;
                    alert("Please upload RRAS Receivable Excel Eile");
                    $("#uploadexcelfile").val('');
                }
                return formOK;
            });
