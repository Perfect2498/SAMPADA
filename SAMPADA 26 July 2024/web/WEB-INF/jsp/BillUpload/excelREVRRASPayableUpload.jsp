<%-- 
    Document   : excelREVRRASPayableUpload
    Created on : 9 Apr, 2020, 2:02:21 AM
    Author     : abt
--%>
    ...
    <body>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br><br>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <legend style="font-size: 16px;"><b>Upload RRAS Down Regulation Bill</b></legend>
            ...
            <table>
                <a  href="downloadREVRRASPayableTemplate.htm">Download REVISED RRAS Down Regulation Bill Template</a>
                <div class="noborderedtable" style="color: #003366;" align="center"><br>

                <form:form action="uploadREVRRASPayable.htm" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
...
//                    if ((ext == "xlsx") && (name == "rras_down_regulation_bill_excel")) {
//                        formOK = true;
//                    }
                if ((ext == "xlsx")) {
                    formOK = true;
                    ...
                    formOK = false;
                    alert("Please upload RRAS  Down Regulation Bill!!");
                    $("#uploadexcelfile").val('');
                }
                return formOK;
            });
