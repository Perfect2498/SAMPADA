<%-- 
    Document   : verifyUploadTRASS
    Created on : 31 Aug, 2023, 11:43:39 AM
    Author     : root
--%>
                    ...
                    "buttons": [
                        {
                            extend: 'pdf',
                            footer: true,
                            title: 'TRAS-S Bill billNo.' + billNo + ' Week No. ' + weekId + 'Issue Date:' + billingDate,
                            orientation: 'landscape',
                            messageTop: function () {
                                return '\r\n         Week No. ' + weekId + '      Bill Issue Date:' + billingDate +
                                        '\r\n \r\n DETAILS OF TRAS-S CHARGES FOR THE WEEK FROM ' + fromDate + '  TO ' + toDate +
                                        '\r\n \r\n (All figures in Rs.)';
                            }
                        },
                        {
    ...
    <body style="min-height: 1500px; width: 95%">
        <form method="post">
            ...
            <table style="color:#003366; width: 90%;" align="center"  border="yes">
                <tr><td align="center"><b> Details of TRAS-S Charges for week From <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempagcdetils.get(0).weekFromdate}" /> To <fmt:formatDate pattern = "dd-MM-yyyy" value = "${tempagcdetils.get(0).weekTodate}" /></b> </td></tr>
