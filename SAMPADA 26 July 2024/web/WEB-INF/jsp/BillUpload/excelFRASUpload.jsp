<%--
    Document   : excelFRASUpload
    Created on : Oct 31, 2019, 3:11:28 PM
    Author     : cdac
--%>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br/>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <table align="center" style="width: 100%;">
                    <a  href="downloadFRASTemplate.htm">Download FRAS Template</a>
                    <div class="noborderedtable" style="color: #003366;" align="center"><br>

                    <form:form action="uploadFRAS.htm" id="form1" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
                        <div id="weekNo"></div>
                        <br/>
                        <div class="container">
