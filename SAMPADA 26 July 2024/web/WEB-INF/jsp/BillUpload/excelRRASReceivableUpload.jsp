<%--
    Document   : excelRRASReceivableUpload
    Created on : Jun 28, 2019, 10:20:40 AM
    Author     : shubham
--%>
    ...
    <body>
        ...
        <p style="color:red;"><c:out value="${msg}"></c:out></p><br><br>
            ...
            <fieldset  style="width:90%;margin-left: 10%;">
                ...
                <legend style="font-size: 16px;"><b>Upload RRAS Up Regulation Bill</b></legend>
                <div>
                ...
                <table>
                    <a  href="downloadRRASReceivableTemplate.htm">Download RRAS Up Regulation Bill Template</a>
                    <div class="noborderedtable" style="color: #003366;" align="center"><br>

                    <form:form action="uploadRRASReceivable.htm" method="post" enctype="multipart/form-data" onsubmit="return formOK;">
