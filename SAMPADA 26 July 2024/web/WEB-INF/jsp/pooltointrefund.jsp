<%-- 
    Document   : pooltointrefund
    Created on : 22 Apr, 2020, 2:11:36 AM
    Author     : abt
--%>
...
<html>
        ...
        <script>
            ...
            function validatecsdf()
            {
                ...
                if (csdfamt != "0")
                {
                    ...
                    {
                        if (-(+csdfamt) > +intbal){
                            alert('Please check that Disburse value is greater than Interest Balance');
                            return false;
                        }
                    }
                    else
    ...
    <body  width="95%">
        <form name="billDirbusementInfoForm" method="post">
           ...
           <h3 align="center" style="color:red;" >+ve amount : From Principal Amount to Interest Amount</h3>
           <h3 align="center" style="color:red;" >-ve amount : From Interest Amount to Principal Amount</h3>
