...
/**
 * BillTrasEDetails generated by hbm2java
 */
public class BillTrasEDetails  implements java.io.Serializable {
    ...
    public BillTrasEDetails() {
    }

	
    public BillTrasEDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public BillTrasEDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, String billCategory, Date entryDate) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
