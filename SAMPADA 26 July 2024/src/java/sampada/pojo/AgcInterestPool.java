...
/**
 * AgcInterestPool generated by hbm2java
 */
public class AgcInterestPool  implements java.io.Serializable {
    ...
    public AgcInterestPool() {
    }

	
    public AgcInterestPool(String accountNumber) {
        this.accountNumber = accountNumber;
    }
    public AgcInterestPool(String accountNumber, String accountName, String ifscCode, String branchName, String branchAddress, String branchNumber, String rldcContactperson, String rldcContactnumber, BigDecimal mainBalance) {
       this.accountNumber = accountNumber;
