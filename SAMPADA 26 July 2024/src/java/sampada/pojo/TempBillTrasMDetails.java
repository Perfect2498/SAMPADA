...
/**
 * TempBillTrasMDetails generated by hbm2java
 */
public class TempBillTrasMDetails  implements java.io.Serializable {
    ...
    public TempBillTrasMDetails() {
    }

	
    public TempBillTrasMDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillTrasMDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, String billCategory, Date entryDate, String billStatus) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
