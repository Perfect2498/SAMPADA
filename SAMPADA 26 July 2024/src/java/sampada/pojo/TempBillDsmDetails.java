...
/**
 * TempBillDsmDetails generated by hbm2java
 */
public class TempBillDsmDetails  implements java.io.Serializable {
    ...
    public TempBillDsmDetails() {
    }

	
    public TempBillDsmDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillDsmDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, Date entryDate, String billStatus) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
