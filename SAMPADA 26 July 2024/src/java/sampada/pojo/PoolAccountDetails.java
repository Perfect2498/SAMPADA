...
/**
 * PoolAccountDetails generated by hbm2java
 */
public class PoolAccountDetails  implements java.io.Serializable {
    ...
    public PoolAccountDetails() {
    }

	
    public PoolAccountDetails(String accountNumber) {
        this.accountNumber = accountNumber;
    }
    public PoolAccountDetails(String accountNumber, String accountName, String ifscCode, String branchName, String branchAddress, String branchNumber, String rldcContactperson, String rldcContactnumber, BigDecimal mainBalance) {
       this.accountNumber = accountNumber;
