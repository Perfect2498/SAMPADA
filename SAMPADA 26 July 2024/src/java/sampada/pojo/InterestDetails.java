...
public class InterestDetails  implements java.io.Serializable {
    ...
    public InterestDetails(BigDecimal interestId) {
        this.interestId = interestId;
    }
    public InterestDetails(BigDecimal interestId, Corporates corporates, BigDecimal weekId, Date billingDate, Date billingDuedate, BigDecimal billedAmount, BigDecimal paidAmount, Date paidDate, BigDecimal interestBilledamount, BigDecimal interestAmount, BigDecimal interestPaidamount, BigDecimal interestPendingamount, Date interestPaiddate, String billType, String billCategory, BigDecimal revisionNo, Date entryDate, String checkerStatus, BigDecimal noofdays, BigDecimal billYear, String remarks, String remarks2, BigDecimal payInterest, BigDecimal recInterest, Set mappingInterestBanks) {
       this.interestId = interestId;
