...
/**
 * TempBillRrasDetails generated by hbm2java
 */
public class TempBillRrasDetails  implements java.io.Serializable {
    ...
    public TempBillRrasDetails() {
    }

	
    public TempBillRrasDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillRrasDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, String billCategory, Date entryDate, String billStatus) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
