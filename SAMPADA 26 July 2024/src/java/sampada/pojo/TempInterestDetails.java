...
/**
 * TempInterestDetails generated by hbm2java
 */
public class TempInterestDetails  implements java.io.Serializable {
    ...
    public TempInterestDetails() {
    }

	
    public TempInterestDetails(BigDecimal interestId) {
        this.interestId = interestId;
    }
    public TempInterestDetails(BigDecimal interestId, Corporates corporates, BigDecimal weekId, Date billingDate, Date billingDuedate, BigDecimal billedAmount, BigDecimal paidAmount, Date paidDate, BigDecimal interestBilledamount, BigDecimal interestAmount, BigDecimal interestPaidamount, BigDecimal interestPendingamount, Date interestPaiddate, String billType, String billCategory, BigDecimal revisionNo, Date entryDate, String checkerStatus, BigDecimal noofdays, BigDecimal billYear) {
       this.interestId = interestId;
