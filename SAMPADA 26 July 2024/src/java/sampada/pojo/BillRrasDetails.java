...
/**
 * BillRrasDetails generated by hbm2java
 */
public class BillRrasDetails  implements java.io.Serializable {
    ...
    public BillRrasDetails() {
    }

	
    public BillRrasDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public BillRrasDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, String billCategory, Date entryDate) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
