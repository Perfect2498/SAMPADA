...
/**
 * TempBillSrasDetails generated by hbm2java
 */
public class TempBillSrasDetails  implements java.io.Serializable {
    ...
    public TempBillSrasDetails() {
    }

	
    public TempBillSrasDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillSrasDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, Date entryDate, String billStatus) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
