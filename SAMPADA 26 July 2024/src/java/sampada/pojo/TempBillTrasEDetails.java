...
/**
 * TempBillTrasEDetails generated by hbm2java
 */
public class TempBillTrasEDetails  implements java.io.Serializable {
    ...
    public TempBillTrasEDetails() {
    }

	
    public TempBillTrasEDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillTrasEDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, String billCategory, Date entryDate, String billStatus) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
