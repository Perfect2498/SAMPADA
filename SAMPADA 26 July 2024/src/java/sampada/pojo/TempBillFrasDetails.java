...
/**
 * TempBillFrasDetails generated by hbm2java
 */
public class TempBillFrasDetails  implements java.io.Serializable {
    ...
    public TempBillFrasDetails() {
    }

	
    public TempBillFrasDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillFrasDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, Date entryDate, String billStatus) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
