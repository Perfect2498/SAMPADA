...
/**
 * BillTrasMDetails generated by hbm2java
 */
public class BillTrasMDetails  implements java.io.Serializable {
    ...
    public BillTrasMDetails() {
    }

	
    public BillTrasMDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public BillTrasMDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, String billCategory, Date entryDate) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
