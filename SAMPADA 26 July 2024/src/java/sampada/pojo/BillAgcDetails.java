...
/**
 * BillAgcDetails generated by hbm2java
 */
public class BillAgcDetails  implements java.io.Serializable {
    ...
    public BillAgcDetails() {
    }

	
    public BillAgcDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public BillAgcDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, Date entryDate) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
