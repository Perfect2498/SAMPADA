...
/**
 * DisbursedInterestDetails generated by hbm2java
 */
public class DisbursedInterestDetails  implements java.io.Serializable {
    ...
    public DisbursedInterestDetails() {
    }

	
    public DisbursedInterestDetails(BigDecimal interestId) {
        this.interestId = interestId;
    }
    public DisbursedInterestDetails(BigDecimal interestId, Corporates corporates, BigDecimal weekId, Date billingDate, Date billingDuedate, BigDecimal billedAmount, BigDecimal disbursedAmount, Date disbursedDate, BigDecimal interestBilledamount, BigDecimal interestAmount, BigDecimal interestPaidamount, BigDecimal interestPendingamount, Date interestPaiddate, String billType, String billCategory, BigDecimal revisionNo, Date entryDate, String checkerStatus, BigDecimal noofdays, BigDecimal billYear, String remarks, String remarks2, BigDecimal payInterest, BigDecimal recInterest, Set paymentInterestDisbursements) {
       this.interestId = interestId;
