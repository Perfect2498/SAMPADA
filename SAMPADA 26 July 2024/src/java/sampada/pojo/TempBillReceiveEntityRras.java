...
/**
 * TempBillReceiveEntityRras generated by hbm2java
 */
public class TempBillReceiveEntityRras  implements java.io.Serializable {
    ...
    public TempBillReceiveEntityRras() {
    }

	
    public TempBillReceiveEntityRras(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillReceiveEntityRras(BigDecimal uniqueId, Corporates corporates, Entites entites, BigDecimal weekId, BigDecimal energyVae, BigDecimal fixedCharges, BigDecimal variableCharges, BigDecimal markupCharges, BigDecimal netRras, BigDecimal billYear, BigDecimal revisionNo, String remarks, BigDecimal wrNetRras, String billStatus, BigDecimal prevWrNetRras) {
       this.uniqueId = uniqueId;
