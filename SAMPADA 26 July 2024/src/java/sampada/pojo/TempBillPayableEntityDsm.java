...
/**
 * TempBillPayableEntityDsm generated by hbm2java
 */
public class TempBillPayableEntityDsm  implements java.io.Serializable {
     ...
     private BigDecimal prevWrNetDsm;

    public TempBillPayableEntityDsm() {
    }

	
    public TempBillPayableEntityDsm(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillPayableEntityDsm(BigDecimal uniqueId, Corporates corporates, Entites entites, BigDecimal weekId, BigDecimal cappingCharges, BigDecimal additionalCharges, BigDecimal signCharges, BigDecimal payableCharges, BigDecimal receivableCharges, BigDecimal netDsm, BigDecimal billYear, BigDecimal revisionNo, String remarks, BigDecimal wrNetDsm, String billStatus, BigDecimal prevWrNetDsm) {
       this.uniqueId = uniqueId;
       ...
       this.prevWrNetDsm = prevWrNetDsm;
    }
    ...
    public BigDecimal getPrevWrNetDsm() {
        return this.prevWrNetDsm;
    }
    
    public void setPrevWrNetDsm(BigDecimal prevWrNetDsm) {
        this.prevWrNetDsm = prevWrNetDsm;
    }
