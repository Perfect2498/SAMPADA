...
/**
 * BillEntityTrasM generated by hbm2java
 */
public class BillEntityTrasM  implements java.io.Serializable {
    ...
    public BillEntityTrasM() {
    }

	
    public BillEntityTrasM(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public BillEntityTrasM(BigDecimal uniqueId, BigDecimal weekId, Corporates corporates, Entites entites, BigDecimal trasUpClearedAhead, BigDecimal trasUpScheduledAhead, BigDecimal trasUpEnergyChargesAhead, BigDecimal trasUpComChargesAhead, BigDecimal trasUpClearedReal, BigDecimal trasUpScheduledReal, BigDecimal trasUpEnergyChargesReal, BigDecimal trasUpComChargesReal, BigDecimal trasUpTotalCharges, BigDecimal trasDownScheduledAhead, BigDecimal trasDownEnergyChargesAhead, BigDecimal trasDownScheduledReal, BigDecimal trasDownEnergyChargesReal, BigDecimal netTras, BigDecimal billYear, BigDecimal revisionNo, String remarks) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
