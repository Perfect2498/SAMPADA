...
/**
 * BillDsmDetails generated by hbm2java
 */
public class BillDsmDetails  implements java.io.Serializable {
    ...
    public BillDsmDetails() {
    }

	
    public BillDsmDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public BillDsmDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, Date entryDate) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
