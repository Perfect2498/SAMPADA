...
/**
 * BillPayableEntityRras generated by hbm2java
 */
public class BillPayableEntityRras  implements java.io.Serializable {
    ...
    public BillPayableEntityRras() {
    }

	
    public BillPayableEntityRras(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public BillPayableEntityRras(BigDecimal uniqueId, Corporates corporates, Entites entites, BigDecimal weekId, BigDecimal energyVae, BigDecimal variableCharges, BigDecimal netRras, BigDecimal billYear, BigDecimal revisionNo, String remarks) {
       this.uniqueId = uniqueId;
