...
/**
 * TempBillAgcDetails generated by hbm2java
 */
public class TempBillAgcDetails  implements java.io.Serializable {
    ...
    public TempBillAgcDetails() {
    }

	
    public TempBillAgcDetails(BigDecimal uniqueId) {
        this.uniqueId = uniqueId;
    }
    public TempBillAgcDetails(BigDecimal uniqueId, BigDecimal weekId, Date weekFromdate, Date weekTodate, Date billingDate, BigDecimal billYear, Date billDueDate, BigDecimal revisionNo, String remarks, String billNo, Date entryDate, String billStatus) {
       this.uniqueId = uniqueId;
       this.weekId = weekId;
